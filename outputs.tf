...
//==================================================
output "region" {
  description = "The value of the `region` input variable, or the provider's region if the input was `null`."
  value       = local.region
}
output "name" {
...
output "enable_shield_drt_access" {
  description = "The value of the `enable_shield_drt_access` input variable, or the default value if the input was `null`."
  value       = var.enable_shield_drt_access
}
